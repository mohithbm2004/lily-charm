          ...
          {mode === 'otp' ? (
            ...
            <>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full py-3 px-4 border border-[var(--color-line)] bg-[var(--color-card-bg)] hover:bg-[var(--color-bg)] transition-colors text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-3 shadow-sm cursor-pointer"
              >
