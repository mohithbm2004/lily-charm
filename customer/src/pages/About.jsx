    ...
    <div className="max-w-5xl mx-auto px-6 md:px-10 pt-16 md:pt-24 pb-24">
      ...
      <Reveal>
        <div className="text-center max-w-3xl mx-auto mb-14 space-y-3">
          ...
          <h1 className="text-4xl md:text-5xl font-bold font-[var(--font-display)] uppercase tracking-tight text-[var(--color-ink)] leading-tight">
            A Dream That Grew With Me
          </h1>
          <p className="text-lg md:text-xl font-serif italic text-[var(--color-primary)] font-semibold pt-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center mb-16">
        ...
        {/* Right Story Text */}
        <div className="md:col-span-7 space-y-6 text-sm md:text-base leading-relaxed text-[var(--color-ink)] font-normal">
          <Reveal delay={0.15}>
            <p className="text-lg font-serif italic font-bold text-[var(--color-primary)] border-l-4 border-[var(--color-primary)] pl-4 py-1 bg-[var(--color-card-bg)]">
      ...
      <div className="space-y-8 max-w-4xl mx-auto">
        <Reveal delay={0.3}>
          <div className="border border-[var(--color-line)] bg-[var(--color-card-bg)] p-6 md:p-8 shadow-sm space-y-3">
            <h2 className="text-xl font-bold font-[var(--font-display)] uppercase tracking-wider text-[var(--color-primary)] flex items-center gap-2">
        ...
        <Reveal delay={0.35}>
          <div className="border border-[var(--color-line)] bg-[var(--color-bg)] p-6 md:p-8 shadow-sm space-y-4">
            <p className="text-sm md:text-base leading-relaxed text-[var(--color-ink)]">
