      ...
      <div className="border border-[var(--color-line)] bg-[var(--color-card-bg)] p-4 sm:p-6 md:p-12 shadow-xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-14 items-center">
          ...
          <div className="md:col-span-5 flex justify-center">
            <Reveal>
              <TiltCard3D intensity={12} className="w-full max-w-md">
                <div className="border border-[var(--color-line)] bg-[var(--color-bg)] p-2.5 sm:p-3 shadow-2xl">
                  <div className="relative overflow-hidden aspect-[4/4.8] border border-[var(--color-line)] bg-[var(--color-card-bg)]">
                    ...
                    />
                    <div className="absolute top-2 left-2 sm:top-3 sm:left-3 bg-[var(--color-bg)]/90 backdrop-blur-sm border border-[var(--color-line)] px-2 py-0.5 sm:px-2.5 sm:py-1 text-[0.6rem] sm:text-[0.65rem] font-bold uppercase tracking-wider text-[var(--color-primary)]">
          ...
          <div className="md:col-span-7 space-y-4 sm:space-y-6">
            ...
            <Reveal delay={0.15}>
              <div className="p-4 sm:p-5 border-l-4 border-[var(--color-primary)] bg-[var(--color-bg)] text-xs sm:text-sm md:text-base leading-relaxed text-[var(--color-ink)] space-y-3 sm:space-y-4 font-normal">
                <p>
            ...
            <Reveal delay={0.2}>
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 pt-2 w-full">
                <Link to="/about" className="btn-primary inline-flex items-center justify-center gap-2 shadow-md hover:scale-105 transition-transform text-center whitespace-nowrap text-xs py-3 w-full sm:w-auto">
                  <Heart size={14} fill="currentColor" /> OUR FULL STORY <ArrowRight size={15} />
                </Link>
                <Link to="/collections" className="btn-outline inline-flex items-center justify-center gap-2 hover:scale-105 transition-transform text-center whitespace-nowrap text-xs py-3 w-full sm:w-auto">
                  EXPLORE COLLECTIONS
                </Link>
              </div>
            </Reveal>
