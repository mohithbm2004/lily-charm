...
export default function Reviews() {
  ...
  const fetchLiveReviews = async () => {
    try {
      ...
      console.log('Error fetching live reviews:', e)
    }
  }
    ...
    <section className="bg-[var(--color-beige)]/40 border-y border-[var(--color-line)] relative overflow-hidden w-full max-w-full">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-10 py-14 sm:py-20 md:py-28 text-center">
        ...
        {reviewsList.length > 0 ? (
                ...
                >
                  ...
                  <div className="mt-3 sm:mt-4 flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 text-xs text-[var(--color-ink-soft)] font-medium">
                    ...
                    {review.isVerifiedBuyer !== false && (
                      <span className="inline-flex items-center gap-1 text-[0.62rem] sm:text-[0.68rem] text-[#212B1C] font-bold bg-[#212B1C]/10 px-2.5 py-0.5 rounded-full border border-[#212B1C]/20">
          ...
          <div className="py-8">
            <p className="text-xs sm:text-sm text-[var(--color-ink-soft)] italic">
              Be the first to share your thoughts on Lily Charm handcrafted botanical creations!
            </p>
          </div>
        )}
