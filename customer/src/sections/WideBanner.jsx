    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-4 sm:py-6 md:py-8 w-full max-w-full">
      <Reveal>
        <TiltCard3D intensity={6} className="w-full">
          <div className="border border-[var(--color-line)] bg-[var(--color-card-bg)] p-2.5 sm:p-3 md:p-4 shadow-lg">
            <div className="relative overflow-hidden aspect-[16/9] sm:aspect-[16/7.5] border border-[var(--color-line)] bg-[#F8F6F0] flex items-center justify-center">
              <img
                ...
                className="w-full h-full object-contain p-1.5 sm:p-2 md:p-3 transition-transform duration-700 hover:scale-105"
              />
            </div>
          </div>
        </TiltCard3D>
