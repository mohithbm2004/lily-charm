...
export const ENV = {
  ...
  ZEPTO: {
    ...
    OTP: {
      ...
      PASS: process.env.ZEPTO_OTP_PASSWORD || process.env.ZEPTO_OTP_API_TOKEN || process.env.ZEPTOMAIL_PASSWORD || '',
    },
    ORDER: {
      ...
      PASS: process.env.ZEPTO_ORDER_PASSWORD || process.env.ZEPTO_ORDER_API_TOKEN || process.env.ZEPTOMAIL_PASSWORD || '',
    },
    SUPPORT: {
      ...
      PASS: process.env.ZEPTO_SUPPORT_PASSWORD || process.env.ZEPTO_SUPPORT_API_TOKEN || process.env.ZEPTOMAIL_PASSWORD || '',
    },
    CONTACT: {
      ...
      PASS: process.env.ZEPTO_CONTACT_PASSWORD || process.env.ZEPTO_CONTACT_API_TOKEN || process.env.ZEPTOMAIL_PASSWORD || '',
    },
  },
